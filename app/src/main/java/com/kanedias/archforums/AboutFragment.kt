...
class AboutFragment: EasyAboutFragment() {
    ...
    override fun configureFragment(ctx: Context, root: View, state: Bundle?) {
        ...
        val sourceCodeItem = AboutItemBuilder.generateLinkItem(ctx, "https://gitlab.com/Kanedias/archforums-android")
                .setTitle(R.string.source_code)
                .setSubtitle(R.string.fork_on_gitlab)
                .setIcon(R.drawable.gitlab)

        val issueItem = AboutItemBuilder.generateLinkItem(ctx, "https://gitlab.com/Kanedias/archforums-android/issues/new")
